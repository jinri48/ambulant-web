...
Route::get('/table-selection',      'PagesController@tableSelection');
Route::get('/tables',               'PagesController@tables');
Route::get('/guest-selection',      'PagesController@guestSelection');
// Route::get('table-selection/{guest_no}', 'PagesController@functiontablecapacity')->name('functiontablecapacity');
